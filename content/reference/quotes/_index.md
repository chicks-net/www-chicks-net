...
date = 2026-03-11
draft = false
# cover.image = '/reference/linux/linux-cover.jpeg'
cover.hidden = true
+++

Amusing and inspiring quotes migrated from a
[dedicated github repo](https://github.com/chicks-net/quote-file).
...
I heard that at [Usenix](https://www.usenix.org/) in San Antonio and I've used
it as my email signature for several years.
...
Kelly even had brandy snifters printed up with "Tested in Production" etched on
them.  Many lol's and toasts ensued.
